...
function showUpdateModal(obj) {
    ...
    console.log(id);
    document.getElementById("update-name").value = tds[0].innerHTML;
    document.getElementById("update-prix-lav").value = tds[2].innerHTML;
    document.getElementById("update-prix-pent").value = tds[1].innerHTML;
